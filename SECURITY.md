...
Report vulnerabilities in this StartOS package using [GitHub private vulnerability reporting](https://github.com/remcoros/frigate-startos/security/advisories/new).

For bugs with no security or privacy impact, open a [regular GitHub issue](https://github.com/remcoros/frigate-startos/issues/new/choose).
